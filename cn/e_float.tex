...
\setupcaption[table][
  ...
  %width=max,	%fit broad max dimension
  %minwidth	fit dimension
  style=floatlabeltext,	%normal bold slanted boldslanted type cap small... command
  headstyle=floatlabelhead,	%normal bold slanted boldslanted type cap small... command
  %number	yes no
  %inbetween	command
  %align	left middle right no
  conversion=numbers,	%numbers characters Characters romannumerals Romannumerals
